...
class ViewRegSuppliers extends Component {
    ...
    fetchSuppliers = () => {
        axios
            .get('https://pharmacy-backend-k2hi.onrender.com/supplier/viewRegSuppliers')
            .then((response) => {
    ...
    handleRemoveSupplier(id) {
        axios
            .delete(`https://pharmacy-backend-k2hi.onrender.com/supplier/delete/${id}`)
            .then((response) => {
                ...
                axios
                    .delete(
                        `https://pharmacy-backend-k2hi.onrender.com/supplier/deleteRegSupplier/${id}`
                    )
                    .then((response) => {
    ...
    handleSearch = () => {
        ...
        axios
            .get(
                `https://pharmacy-backend-k2hi.onrender.com/supplier/searchRegSuppliers?search=${searchQuery}`
            )
            .then((response) => {
    ...
    render() {
        ...
        return (
            <div id="view-registered-supplier" className='view-registered-supplier'>
                <h2 id="view-registered-supplier-head" className='view-registered-supplier-head'>Manger Details</h2>
