...
useEffect(()=>{
    function getSuppliers(){
        axios.get("https://pharmacy-backend-k2hi.onrender.com/supplier/").then((res)=>{
...
const handleAccept = (id) => {
    ...
    axios.get(`https://pharmacy-backend-k2hi.onrender.com/supplier/get/${id}`)
    ...
    const {password} = res.data.supplier;  
        ...
        axios.post('https://pharmacy-backend-k2hi.onrender.com/supplier/addRegSuppliers', newSupplier)
          .then(res => {
          ...
          saveAs(blob, `${name}_report.xml`);
            axios.delete(`https://pharmacy-backend-k2hi.onrender.com/supplier/delete/${id}`)
