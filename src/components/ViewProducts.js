...
const ProductsList = () => {
  ...
  useEffect(() => {
    axios.get('https://pharmacy-backend-k2hi.onrender.com/product/viewProducts')
      .then(res => setProducts(res.data))
      .catch(err => console.log(err));
  }, [deletedProductId, updatedProduct]);

  const handleDelete = (id) => {
    axios.delete(`https://pharmacy-backend-k2hi.onrender.com/product/deleteProduct/${id}`)
  ...
  const handleUpdate = (id, updatedProduct) => {
    axios.put(`https://pharmacy-backend-k2hi.onrender.com/product/updateProduct/${id}`, updatedProduct)
      .then(res => {
