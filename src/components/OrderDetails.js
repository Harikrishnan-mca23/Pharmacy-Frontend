...
//   const navigate = useNavigate();
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://pharmacy-backend-k2hi.onrender.com/report/viewReports/${supplierId}`)
      .then((response) => {
  ...
  const handleAccept = (id) => {
    ...
    axios
      .delete(`https://pharmacy-backend-k2hi.onrender.com/report/deleteReports/${id}`)
      .then((response) => {
...
const handleDecline = async (orderid,id) => {
  ...
  if (reason) {
    ...
    try {
      ...
      const response = await axios.post('https://pharmacy-backend-k2hi.onrender.com/decline/decline-reasons', declineData);
