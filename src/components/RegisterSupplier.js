...
const RegisterSupplier = () => {
  ...
  // const [passwordError, setPasswordError] = useState('');
    ...
    const checkEmail = async (email) => {
      try {
        const response = await axios.get(`https://pharmacy-backend-k2hi.onrender.com/supplier/check-email/${email}`);
    ...
    try {
      await axios.post("https://pharmacy-backend-k2hi.onrender.com/supplier/add", supplier);
